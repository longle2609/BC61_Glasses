  ...
  for (const glass of dataGlasses) {
    html += `
        <div class="col-4 vglasses__items">
            <img style="max-width: 100%;" src="${glass.src}" onclick="wearGlass('${glass.id}')">
        </div>
    `;
  }
...
window.wearGlass = (glassID) => {
  let glass = dataGlasses.find((glass) => glass.id === glassID);
  document.querySelector("#avatar").innerHTML = `
    <img src="${glass.virtualImg}" id="glasses">
  `;
